...
class CvDomesticAdvisor:
        ...
        def drawHeaders( self ):
                ...
                # Population Column
                screen.setTableColumnHeader( "CityListBackground", 2, "<font=2>" + localText.getText("TXT_KEY_POPULATION", ()) + "</font>", (35 * self.nTableWidth) / self.nNormalizedTableWidth )

                # Settled Slaves Column
                screen.setTableColumnHeader( "CityListBackground", 3, "<font=2>" + localText.getText("TXT_KEY_DOMESTIC_ADVISOR_SLAVES", ()) + "</font>", (35 * self.nTableWidth) / self.nNormalizedTableWidth )

                # Happiness Column
                screen.setTableColumnHeader( "CityListBackground", 4, "<font=2>" + (u"%c" % CyGame().getSymbolID(FontSymbols.HAPPY_CHAR)) + "</font>", (35 * self.nTableWidth) / self.nNormalizedTableWidth )

                # Health Column
                screen.setTableColumnHeader( "CityListBackground", 5, "<font=2>" + (u"%c" % CyGame().getSymbolID(FontSymbols.HEALTHY_CHAR)) + "</font>", (35 * self.nTableWidth) / self.nNormalizedTableWidth )

                # Food Column
                screen.setTableColumnHeader( "CityListBackground", 6, "<font=2>" + (u"%c" % gc.getYieldInfo(YieldTypes.YIELD_FOOD).getChar()) + "</font>", (35 * self.nTableWidth) / self.nNormalizedTableWidth )

                # Production Column
                screen.setTableColumnHeader( "CityListBackground", 7, "<font=2>" + (u"%c" % gc.getYieldInfo(YieldTypes.YIELD_PRODUCTION).getChar()) + "</font>", (35 * self.nTableWidth) / self.nNormalizedTableWidth )

                # Gold Column
                screen.setTableColumnHeader( "CityListBackground", 8, "<font=2>" + (u"%c" % gc.getCommerceInfo(CommerceTypes.COMMERCE_GOLD).getChar()) + "</font>", (35 * self.nTableWidth) / self.nNormalizedTableWidth )
                ...
                screen.setTableColumnHeader( "CityListBackground", 10, "<font=2>" + szText, (40 * self.nTableWidth) / self.nNormalizedTableWidth )

                # Culture Column
                screen.setTableColumnHeader( "CityListBackground", 11, "<font=2>" + (u"%c" % gc.getCommerceInfo(CommerceTypes.COMMERCE_CULTURE).getChar()) + "</font>", (60 * self.nTableWidth) / self.nNormalizedTableWidth )

                # Trade Column
                screen.setTableColumnHeader( "CityListBackground", 12, "<font=2>" + (u"%c" % CyGame().getSymbolID(FontSymbols.TRADE_CHAR)) + "</font>", (35 * self.nTableWidth) / self.nNormalizedTableWidth )

                # Maintenance Column
                screen.setTableColumnHeader( "CityListBackground", 13, "<font=2>" + (u"%c" % CyGame().getSymbolID(FontSymbols.BAD_GOLD_CHAR)) + "</font>", (35 * self.nTableWidth) / self.nNormalizedTableWidth )

                # Great Person Column
                screen.setTableColumnHeader( "CityListBackground", 14, "<font=2>" + (u"%c" % CyGame().getSymbolID(FontSymbols.GREAT_PEOPLE_CHAR)) + "</font>", (70 * self.nTableWidth) / self.nNormalizedTableWidth )

                # Garrison Column
                screen.setTableColumnHeader( "CityListBackground", 15, "<font=2>" + (u"%c" % CyGame().getSymbolID(FontSymbols.DEFENSE_CHAR)) + "</font>", (35 * self.nTableWidth) / self.nNormalizedTableWidth )

                # Production Column
                screen.setTableColumnHeader( "CityListBackground", 16, "<font=2>" + localText.getText("TXT_KEY_DOMESTIC_ADVISOR_PRODUCING", ()) + "</font>", (125 * self.nTableWidth) / self.nNormalizedTableWidth )

                # Liberate Column
                screen.setTableColumnHeader( "CityListBackground", 17, "", (25 * self.nTableWidth) / self.nNormalizedTableWidth )

                # Stop Growth Column
                screen.setTableColumnHeader( "CityListBackground", 18, "<font=2>" + localText.getText("TXT_KEY_DOM_ADVISOR_GROWTH1", ()) + "</font>", (90 * self.nTableWidth) / self.nNormalizedTableWidth )
        ...
        def updateTable(self, pLoopCity, i):
                ...
                # Settled Slaves
                iCitySlaves = pLoopCity.getFreeSpecialistCount(15)  # SPECIALIST_GLADIATOR
                iCitySlaves += pLoopCity.getFreeSpecialistCount(16) # SPECIALIST_SLAVE
                iCitySlaves += pLoopCity.getFreeSpecialistCount(17) # SPECIALIST_SLAVE_FOOD
                iCitySlaves += pLoopCity.getFreeSpecialistCount(18) # SPECIALIST_SLAVE_PROD
                screen.setTableInt( "CityListBackground", 3, i, unicode(iCitySlaves), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY )
                ...
                # Production status...
                screen.setTableInt( "CityListBackground", 7, i, unicode(pLoopCity.getYieldRate(YieldTypes.YIELD_PRODUCTION)), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY )

                # Gold status...
                screen.setTableInt( "CityListBackground", 8, i, unicode(pLoopCity.getCommerceRate(CommerceTypes.COMMERCE_GOLD)), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY )

                # Science rate...
                screen.setTableInt( "CityListBackground", 9, i, unicode(pLoopCity.getCommerceRate(CommerceTypes.COMMERCE_RESEARCH)), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY )

                # Espionage rate...
                screen.setTableInt( "CityListBackground", 10, i, unicode(pLoopCity.getCommerceRate(CommerceTypes.COMMERCE_ESPIONAGE)), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY )
                ...
                screen.setTableInt( "CityListBackground", 11, i, szCulture, "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY )

                # Trade
                screen.setTableInt( "CityListBackground", 12, i, unicode(pLoopCity.getTradeYield(YieldTypes.YIELD_COMMERCE)), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY )

                # Maintenance...
                screen.setTableInt( "CityListBackground", 13, i, unicode(pLoopCity.getMaintenance()), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY )
                ...
                screen.setTableInt( "CityListBackground", 14, i, szGreatPerson, "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY )

                # Garrison
                screen.setTableInt( "CityListBackground", 15, i, unicode(pLoopCity.plot().getNumDefenders(pLoopCity.getOwner())), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY )
                ...
                screen.setTableText( "CityListBackground", 18, i, szText, "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_CENTER_JUSTIFY )
