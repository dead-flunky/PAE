        ...
        def placeTechs (self):
                ...
                for i in range(gc.getNumTechInfos()):
                        ...
                        ### Unit Formations
                                ...
                                fX += X_INCREMENT
                        elif i == gc.getInfoTypeForString("TECH_BEWAFFNUNG4"):
                        ...
                        # Actions
                                ...
                                screen.addDDSGFCAt( "", szTechRecord, ArtFileMgr.getInterfaceArtInfo("INTERFACE_BORDELL").getPath(), iX + fX, iY + Y_ROW, TEXTURE_SIZE, TEXTURE_SIZE, WidgetTypes.WIDGET_GENERAL, 668, 668, False )
                                fX += X_INCREMENT
                        elif i == gc.getInfoTypeForString("TECH_GLADIATOR"):
                                ...
                                screen.addDDSGFCAt( "", szTechRecord, ArtFileMgr.getInterfaceArtInfo("INTERFACE_THEATRE").getPath(), iX + fX, iY + Y_ROW, TEXTURE_SIZE, TEXTURE_SIZE, WidgetTypes.WIDGET_GENERAL, 670, 670, False )
                                fX += X_INCREMENT
                        elif i == gc.getInfoTypeForString("TECH_KUNST"):
                                screen.addDDSGFCAt( "", szTechRecord, ArtFileMgr.getInterfaceArtInfo("INTERFACE_SCHULE").getPath(), iX + fX, iY + Y_ROW, TEXTURE_SIZE, TEXTURE_SIZE, WidgetTypes.WIDGET_GENERAL, 679, 679, False )
                                fX += X_INCREMENT
                        elif i == gc.getInfoTypeForString("TECH_MANUFAKTUREN"):
                                screen.addDDSGFCAt( "", szTechRecord, ArtFileMgr.getInterfaceArtInfo("INTERFACE_MANUFAKTUR_0").getPath(), iX + fX, iY + Y_ROW, TEXTURE_SIZE, TEXTURE_SIZE, WidgetTypes.WIDGET_GENERAL, 680, 680, False )
                                fX += X_INCREMENT
                                screen.addDDSGFCAt( "", szTechRecord, ArtFileMgr.getInterfaceArtInfo("INTERFACE_MANUFAKTUR_1").getPath(), iX + fX, iY + Y_ROW, TEXTURE_SIZE, TEXTURE_SIZE, WidgetTypes.WIDGET_GENERAL, 681, 681, False )
                                fX += X_INCREMENT
