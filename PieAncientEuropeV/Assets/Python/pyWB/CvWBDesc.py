    ...
    def apply(self):
        ...
        if (player):
            ...
            if (unitTypeNum < 0):
                ...
                unit = player.initUnit(unitTypeNum, self.plotX, self.plotY, UnitAITypes(eUnitAI), self.facingDirection, player.getCivilizationType(), player.getStateReligion())
            if unit:
                if (self.szName != None):
