...
def setHolyCity():
    ...
    if pCity == None:
      ...
      if len(lCities) > 0:
        pCity = lCities[CvEventInterface.getEventManager().myRandom(len(lCities), None)]
    ...
    if pCity == None:
      ...
      if pCity == None:
        if len(lCities) > 0: pCity = lCities[CvEventInterface.getEventManager().myRandom(len(lCities), None)]
