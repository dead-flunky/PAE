...
// Flunky
m_iHEALTH_PER_POPULATION(0),
m_iHAPPY_PER_POPULATION(0),
// End Flunky
m_iMAX_HIT_POINTS(0),
...
// Begin Flunky Goods
m_iNUM_GOODS_PREREQ_OR_BONUSES(0),
m_iNUM_GOODS_PREREQ_AND_BONUSES(0),
// End Flunky Goods
...
void CvGlobals::cacheGlobals()
{
	...
	m_iHEALTH_PER_POPULATION = getDefineINT("HEALTH_PER_POPULATION");
	m_iHAPPY_PER_POPULATION = getDefineINT("HAPPY_PER_POPULATION");
	...
	// Begin Flunky
	m_iNUM_GOODS_PREREQ_OR_BONUSES = getDefineINT("NUM_GOODS_PREREQ_OR_BONUSES");
	m_iNUM_GOODS_PREREQ_AND_BONUSES = getDefineINT("NUM_GOODS_PREREQ_AND_BONUSES");
	// End Flunky
...
// PAE
int CvGlobals::getHEALTH_PER_POPULATION()
{
	return m_iHEALTH_PER_POPULATION;
}

int CvGlobals::getHAPPY_PER_POPULATION()
{
	return m_iHAPPY_PER_POPULATION;
}
...
// Begin Flunky Goods
int CvGlobals::getNUM_GOODS_PREREQ_OR_BONUSES()
{
	return m_iNUM_GOODS_PREREQ_OR_BONUSES;
}

int CvGlobals::getNUM_GOODS_PREREQ_AND_BONUSES()
{
	return m_iNUM_GOODS_PREREQ_AND_BONUSES;
}
// End Flunky Goods
