...
void CyCityPythonInterface1(python::class_<CyCity>& x)
{
	...
	x
		...
		.def("changeBuildingCommerceChange", &CyCity::changeBuildingCommerceChange, "void (int /*BuildingClassTypes*/ eBuildingClass, int /*CommerceTypes*/ eCommerce, int iChange)")
